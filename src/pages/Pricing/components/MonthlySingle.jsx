    ...
    <div class="w-full lg:max-w-[557px] lg:px-[36px] lg:pt-[70px] pt-8 pb-4 px-5 bg-white border border-gray-200 rounded-[24px] shadow sm:p-8">
      ...
      <ul role="list" class="space-y-2 my-7">
        ...
        <li class="flex">
          ...
          <span class="line-through lg:text-[18px] text-[15px] leading-tight text-gray-500 dark:text-gray-400 ms-3">
            Unlimited users
          </span>
        </li>
      </ul>
      <button
        type="button"
        class="text-white lg:text-[18px] focus:ring-4 lg:mt-[20px] mt-0 focus:outline-none gradient_icon font-medium rounded-[12px] text-sm px-5 lg:py-[20px] py-2.5 w-full text-center"
      >
