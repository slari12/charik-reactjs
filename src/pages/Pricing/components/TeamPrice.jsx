...
export default function TeamPrice() {
  return (
    <div className="w-full lg:max-w-[557px] lg:px-[36px] lg:pt-[70px] pt-8 pb-4 px-5 bg-white border border-gray-200 rounded-[24px] shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
      <div className="flex items-baseline text-gray-900 lg:mb-[28.8px] mb-0">
      ...
      <button
        type="button"
        className="text-white lg:text-[18px] focus:ring-4 lg:mt-[20px] mt-0 focus:outline-none lg:py-[20px] gradient_border font-medium rounded-[12px] text-sm px-5 py-2.5  w-full text-center"
      >
